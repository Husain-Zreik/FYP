...
export default function CivilianDetailPage() {
  ...
  if (loading) return (
    <ShelterLayout title="Civilian" back="/shelter/civilians">
  ...
  return (
    <ShelterLayout
      title={civilian.name}
      subtitle="Civilian profile"
      back="/shelter/civilians"
    ...
    >
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        ...
        <div className="bg-background rounded-2xl border border-border p-6 lg:col-span-2">
          <h2 className="text-sm font-semibold font-heading text-text mb-4">Account</h2>
          <div className="grid sm:grid-cols-2 gap-6">
            <div>
              <p className="text-[10px] font-semibold text-text-subtle uppercase tracking-wider mb-1">Shelter</p>
              <p className="text-sm font-medium text-text">{civilian.shelter?.name ?? '—'}</p>
            </div>
            <div>
