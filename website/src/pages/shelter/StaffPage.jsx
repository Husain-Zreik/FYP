  ...
  return (
    <ShelterLayout title="Staff">
      ...
      <Table
        ...
        data={filtered}
        loading={loading}
        emptyText="No staff members yet. Add your first one above."
      />

      {panel !== null && (
        <UserPanel
          editingUser={panel.user}
          availableRoles={SHELTER_ROLES}
          showShelter={false}
          onSave={handleSave}
      ...
      {delTarget && (
        <ConfirmDialog
          ...
          message={<><span className="font-semibold text-text">{delTarget.name}</span> will be permanently removed from this shelter.</>}
          confirmLabel="Remove"
